  ...
  <body class="skin-red fixed">
    <div class="wrapper">
      ...
      <header class="main-header">
        <!-- Logo -->
        <a href="<?=base_url();?>" class="logo"><?php echo $this->apps->title;?></a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class=""><a href="<?=base_url();?>"><i class="fa fa-circle-o"></i> General</a></li>
              </ul>
            </li>
            
            <li class="treeview">
              <a href="#">
                <span>Latihan</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
